...
class DriversRegistry
{
     ...
     * @return array
     */
    public function getDriversExts()
    {
     ...
     */
    public function getFromExt($ext)
    {
     ...
     * @return array
     */
    public function getDriverSUPPORTEDEXTS($alias)
    {
     ...
     * @return bool
     */
    public function driverHasExt($driverAlias, $ext)
    {
     ...
     * @return bool
     */
    public function driverSupportsExt($ext)
    {
